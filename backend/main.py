...
mongo_connection_string = "mongodb+srv://abdullaharean:<password>@cluster0.q5w1r.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5137"],  # Adjust this based on your frontend's domain
